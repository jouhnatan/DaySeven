...
/// Differences, the timeline reader for Timelines, the settings pane for
/// World, and the stats editor for Economy.
enum DsView { editor, differences, timelines, world, economy }
